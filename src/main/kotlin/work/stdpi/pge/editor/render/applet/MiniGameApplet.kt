...
import work.stdpi.pge.editor.render.MiniGameRenderer
...
object MiniGameApplet : IEditorApplet {
  private val renderer = MiniGameRenderer()

  override val id: String = "minigame"
  override val displayName: String = "Mini Game"
